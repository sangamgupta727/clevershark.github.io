!(function (e, t) {
            ...
            for ("boolean" == typeof a && ((l = a), (a = arguments[s] || {}), s++), "object" == typeof a || p.isFunction(a) || (a = {}), s === u && ((a = this), s--); u > s; s++)
                if (null != (i = arguments[s]))
                    for (r in i)
                        (e = a[r]),
                            a !== (n = i[r]) &&
                                (l && n && (p.isPlainObject(n) || (t = p.isArray(n))) ? (t ? ((t = !1), (o = e && p.isArray(e) ? e : [])) : (o = e && p.isPlainObject(e) ? e : {}), (a[r] = p.extend(l, o, n))) : void 0 !== n && (a[r] = n));
            return a;
        }),
        p.extend({
            ...
            each: function (e, t) {
                var n,
                    r = 0;
                if (y(e)) for (n = e.length; n > r && !1 !== t.call(e[r], r, e[r]); r++);
            ...
            map: function (e, t, n) {
                var r,
                    ...
                    a = 0,
                    s = [];
                if (y(e)) for (r = e.length; r > a; a++) null != (i = t(e[a], a, n)) && s.push(i);
    ...
    var x = (function (e) {
        ...
        (ie.matchesSelector = function (e, t) {
            if (((e.ownerDocument || e) !== p && f(e), (t = t.replace(X, "='$1']")), n.matchesSelector && g && !k[t + " "] && (!v || !v.test(t)) && (!m || !m.test(t))))
                try {
                    var r = y.call(e, t);
                        ...
                        : function (t, n, u) {
                              ...
                              if (m) {
                                  ...
                                  if (((h = [a ? m.firstChild : m.lastChild]), a && y)) {
                                      for (
                                          x = (p = (l = (c = (d = (f = m)[b] || (f[b] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] || [])[0] === T && l[1]) && l[2], f = p && m.childNodes[p];
                                      ...
                                      for (
                                          ;
                                          (f = (++p && f && f[g]) || (x = p = 0) || h.pop()) &&
                                          ((s ? f.nodeName.toLowerCase() !== v : 1 !== f.nodeType) || !++x || (y && ((c = (d = f[b] || (f[b] = {}))[f.uniqueID] || (d[f.uniqueID] = {}))[e] = [T, x]), f !== t));
            ...
            return (
                ...
                ae(function (o, a, s, u) {
                    var l,
                        ...
                        v = n ? (i || (o ? e : h || r) ? [] : a) : m;
                    if ((n && n(m, v, s, u), r)) for (l = ye(v, p), r(l, [], s, u), c = l.length; c--; ) (d = l[c]) && (v[p[c]] = !(m[p[c]] = d));
                    if (o) {
                        if (i || e) {
                            if (i) {
            ...
            for (
                ...
                if ((n = r.relative[e[u].type])) f = [me(ve(f), n)];
                    ...
                    if ((n = r.filter[e[u].type].apply(null, e[u].matches))[b]) {
                        ...
                        return xe(u > 1 && ve(f), u > 1 && ge(e.slice(0, u - 1).concat({ value: " " === e[u - 2].type ? "*" : "" })).replace(I, "$1"), n, i > u && be(e.slice(u, i)), o > i && be((e = e.slice(i))), o > i && ge(e));
                    }
                    f.push(n);
                }
            return ve(f);
    ...
    p.extend({
        ...
        when: function (e) {
            ...
            if (s > 1) for (t = new Array(s), n = new Array(s), r = new Array(s); s > o; o++) a[o] && p.isFunction(a[o].promise) ? a[o].promise().progress(c(o, n, t)).done(c(o, r, a)).fail(l.reject) : --u;
    ...
    (d.ownFirst = "0" === H),
        ...
        p(function () {
            ...
            (n = r.getElementsByTagName("body")[0]) &&
                ...
                void 0 !== t.style.zoom && ((t.style.cssText = "display:inline;margin:0;border:0;padding:1px;width:1px;zoom:1"), (d.inlineBlockNeedsLayout = e = 3 === t.offsetWidth), e && (n.style.zoom = 1)),
                n.removeChild(i));
        }),
        (function () {
    ...
    var Y = function (e, t, n, r, i, o, a) {
            var s = 0,
                u = e.length,
                l = null == n;
            if ("object" === p.type(n)) for (s in ((i = !0), n)) Y(e, t, s, n[s], !0, o, a);
            else if (
                void 0 !== r &&
                ((i = !0),
                p.isFunction(r) || (a = !0),
    ...
    function ne(e, t) {
        ...
        if (!o) for (o = [], n = e.childNodes || e; null != (r = n[i]); i++) !t || p.nodeName(r, t) ? o.push(r) : p.merge(o, ne(r, t));
    ...
    function se(e, t, n, r, i) {
            ...
            if ((a = e[v]) || 0 === a)
                if ("object" === p.type(a)) p.merge(m, a.nodeType ? [a] : a);
                    ...
                    if ((!d.leadingWhitespace && K.test(a) && m.push(t.createTextNode(K.exec(a)[0])), !d.tbody))
                        for (o = (a = "table" !== l || oe.test(a) ? ("<table>" !== f[1] || oe.test(a) ? 0 : u) : u.firstChild) && a.childNodes.length; o--; )
        ...
        for (u && g.removeChild(u), d.appendChecked || p.grep(ne(m, "input"), ae), v = 0; (a = m[v++]); )
            ...
            else if (((s = p.contains(a.ownerDocument, a)), (u = ne(g.appendChild(a), "script")), s && re(u), n)) for (o = 0; (a = u[o++]); ) Q.test(a.type || "") && n.push(a);
        return (u = null), g;
    }
    !(function () {
        var t,
        ...
        for (t in { submit: !0, change: !0, focusin: !0 }) (n = "on" + t), (d[t] = n in e) || (i.setAttribute(n, "t"), (d[t] = !1 === i.attributes[n].expando));
        i = null;
    })();
    ...
    (p.event = {
                ...
                for (
                    ...
                    (h = m = (o = fe.exec(t[s]) || [])[1]),
                        ...
                        h &&
                            ...
                            (l = p.event.special[h] || {}),
                            (d = p.extend({ type: h, origType: m, data: r, handler: n, guid: n.guid, selector: i, needsContext: i && p.expr.match.needsContext.test(i), namespace: g.join(".") }, u)),
                            (f = a[h]) || (((f = a[h] = []).delegateCount = 0), (l.setup && !1 !== l.setup.call(e, r, g, c)) || (e.addEventListener ? e.addEventListener(h, c, !1) : e.attachEvent && e.attachEvent("on" + h, c))),
            ...
            if (v && (c = v.events)) {
                for (l = (t = (t || "").match(q) || [""]).length; l--; )
                    if (((h = m = (s = fe.exec(t[l]) || [])[1]), (g = (s[2] || "").split(".").sort()), h)) {
                        for (d = p.event.special[h] || {}, f = c[(h = (r ? d.delegateType : d.bindType) || h)] || [], s = s[2] && new RegExp("(^|\\.)" + g.join("\\.(?:.*\\.|)") + "(\\.|$)"), u = o = f.length; o--; )
                            (a = f[o]),
                                (!i && m !== a.origType) ||
                                    (n && n.guid !== a.guid) ||
        ...
        trigger: function (t, n, i, o) {
            ...
            if (
                ...
                3 !== i.nodeType &&
                    ...
                    (s = m.indexOf(":") < 0 && "on" + m),
                    ((t = t[p.expando] ? t : new p.Event(m, "object" == typeof t && t)).isTrigger = o ? 2 : 3),
                    (t.namespace = v.join(".")),
                ...
                for (h = 0; (u = g[h++]) && !t.isPropagationStopped(); )
                    (t.type = h > 1 ? l : d.bindType || m),
                        (a = (p._data(u, "events") || {})[t.type] && p._data(u, "handle")) && a.apply(u, n),
        ...
        dispatch: function (e) {
            ...
            if (((u[0] = e), (e.delegateTarget = this), !c.preDispatch || !1 !== c.preDispatch.call(this, e))) {
                for (s = p.event.handlers.call(this, e, l), t = 0; (o = s[t++]) && !e.isPropagationStopped(); )
                    for (e.currentTarget = o.elem, n = 0; (a = o.handlers[n++]) && !e.isImmediatePropagationStopped(); )
                        (e.rnamespace && !e.rnamespace.test(a.namespace)) ||
                            ((e.handleObj = a), (e.data = a.data), void 0 !== (r = ((p.event.special[a.origType] || {}).handle || a.handler).apply(o.elem, u)) && !1 === (e.result = r) && (e.preventDefault(), e.stopPropagation()));
        ...
        (p.Event = function (e, t) {
            return this instanceof p.Event
                ? (e && e.type ? ((this.originalEvent = e), (this.type = e.type), (this.isDefaultPrevented = e.defaultPrevented || (void 0 === e.defaultPrevented && !1 === e.returnValue) ? pe : he)) : (this.type = e),
                  t && p.extend(this, t),
    ...
    function Ae(e, t) {
        if (1 === t.nodeType && p.hasData(e)) {
            var n,
                ...
                a = p._data(t, o),
                s = o.events;
            if (s) for (n in (delete a.handle, (a.events = {}), s)) for (r = 0, i = s[n].length; i > r; r++) p.event.add(t, n, s[n][r]);
    ...
    function De(e, t) {
        ...
        if (1 === t.nodeType) {
            ...
            "script" === n && t.text !== e.text
                ...
                : "object" === n
                ? (t.parentNode && (t.outerHTML = e.outerHTML), d.html5Clone && e.innerHTML && !p.trim(t.innerHTML) && (t.innerHTML = e.innerHTML))
        ...
        if (h && ((i = (c = se(t, e[0].ownerDocument, !1, e, r)).firstChild), 1 === c.childNodes.length && (c = i), i || r)) {
            ...
            if (s)
                for (l = u[u.length - 1].ownerDocument, p.map(u, Se), f = 0; s > f; f++)
                    (a = u[f]), Q.test(a.type || "") && !p._data(a, "globalEval") && p.contains(l, a) && (a.src ? p._evalUrl && p._evalUrl(a.src) : p.globalEval((a.text || a.textContent || a.innerHTML || "").replace(Ce, "")));
            c = i = null;
        }
        return e;
    }
    ...
    p.extend({
        ...
        clone: function (e, t, n) {
            ...
            if (
                (d.html5Clone || p.isXMLDoc(e) || !ye.test("<" + e.nodeName + ">") ? (o = e.cloneNode(!0)) : ((Ee.innerHTML = e.outerHTML), Ee.removeChild((o = Ee.firstChild))),
                !((d.noCloneEvent && d.noCloneChecked) || (1 !== e.nodeType && 11 !== e.nodeType) || p.isXMLDoc(e)))
            )
                for (r = ne(o), s = ne(e), a = 0; null != (i = s[a]); ++a) r[a] && De(i, r[a]);
            if (t)
                if (n) for (s = s || ne(e), r = r || ne(o), a = 0; null != (i = s[a]); a++) Ae(i, r[a]);
                else Ae(e, o);
    ...
    function Fe(e) {
        ...
        return (
            n ||
                (("none" !== (n = _e(e, t)) && n) ||
                    ((t = ((He = (He || p("<iframe frameborder='0' width='0' height='0'/>")).appendTo(t.documentElement))[0].contentWindow || He[0].contentDocument).document).write(), t.close(), (n = _e(e, t)), He.detach()),
                (qe[e] = n)),
            n
        );
    }
    ...
    !(function () {
        ...
        if (l.style) {
            ...
            (l.style.cssText = "float:left;opacity:.5"),
                ...
                (l.innerHTML = ""),
                u.appendChild(l),
                (d.boxSizing = "" === l.style.boxSizing || "" === l.style.MozBoxSizing || "" === l.style.WebkitBoxSizing),
                p.extend(d, {
        ...
        ? ((Be = function (t) {
          ...
          (We = function (e, t, n) {
              var r,
                  ...
                  s = e.style;
              return (
                  ("" !== (a = (n = n || Be(e)) ? n.getPropertyValue(t) || n[t] : void 0) && void 0 !== a) || p.contains(e.ownerDocument, e) || (a = p.style(e, t)),
                  n && !d.pixelMarginRight() && Oe.test(a) && Me.test(t) && ((r = s.width), (i = s.minWidth), (o = s.maxWidth), (s.minWidth = s.maxWidth = s.width = a), (a = n.width), (s.width = r), (s.minWidth = i), (s.maxWidth = o)),
                  void 0 === a ? a : a + ""
              );
          }))
        : Pe.currentStyle &&
          ...
          (We = function (e, t, n) {
              var r,
                  ...
                  s = e.style;
              return (
                  null == (a = (n = n || Be(e)) ? n[t] : void 0) && s && s[t] && (a = s[t]),
                  Oe.test(a) && !Ie.test(t) && ((r = s.left), (o = (i = e.runtimeStyle) && i.left) && (i.left = e.currentStyle.left), (s.left = "fontSize" === t ? "1em" : a), (a = s.pixelLeft + "px"), (s.left = r), o && (i.left = o)),
                  void 0 === a ? a : a + "" || "auto"
              );
          }));
    var ze = /alpha\([^)]*\)/i,
    ...
    function Ke(e) {
        if (e in Qe) return e;
        for (var t = e.charAt(0).toUpperCase() + e.slice(1), n = Ge.length; n--; ) if ((e = Ge[n] + t) in Qe) return e;
    }
    function Ze(e, t) {
        for (var n, r, i, o = [], a = 0, s = e.length; s > a; a++)
            (r = e[a]).style &&
                ...
                (n = r.style.display),
                t
                    ? (o[a] || "none" !== n || (r.style.display = ""), "" === r.style.display && U(r) && (o[a] = p._data(r, "olddisplay", Fe(r.nodeName))))
                    : ((i = U(r)), ((n && "none" !== n) || !i) && p._data(r, "olddisplay", i ? n : p.css(r, "display"))));
    ...
    function tt(e, t, n, r, i) {
        for (var o = n === (r ? "border" : "content") ? 4 : "width" === t ? 1 : 0, a = 0; 4 > o; o += 2)
            "margin" === n && (a += p.css(e, n + X[o], !0, i)),
                r
                    ? ("content" === n && (a -= p.css(e, "padding" + X[o], !0, i)), "margin" !== n && (a -= p.css(e, "border" + X[o] + "Width", !0, i)))
                    : ((a += p.css(e, "padding" + X[o], !0, i)), "padding" !== n && (a += p.css(e, "border" + X[o] + "Width", !0, i)));
        return a;
    }
    function nt(e, t, n) {
        var r = !0,
    ...
    p.extend({
        ...
        style: function (e, t, n, r) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                if (
                    ...
                    null != n &&
                        n == n &&
                        ("number" === o && (n += (i && i[3]) || (p.cssNumber[s] ? "" : "px")), d.clearCloneStyle || "" !== n || 0 !== t.indexOf("background") || (u[t] = "inherit"), !(a && "set" in a && void 0 === (n = a.set(e, n, r)))))
                )
                    try {
                        u[t] = n;
                    } catch (e) {}
        ...
        (p.cssHooks.marginRight = $e(d.reliableMarginRight, function (e, t) {
            return t ? Re(e, { display: "inline-block" }, We, [e, "marginRight"]) : void 0;
        })),
    ...
    function ct(e, t, n) {
        for (var r, i = (dt.tweeners[t] || []).concat(dt.tweeners["*"]), o = 0, a = i.length; a > o; o++) if ((r = i[o].call(n, t, e))) return r;
    }
    function dt(e, t, n) {
        var r,
            i,
    ...
    (p.Animation = p.extend(dt, {
        ...
        prefilters: [
            function (e, t, n) {
                ...
                1 === e.nodeType &&
                    ...
                    "inline" === ("none" === (l = p.css(e, "display")) ? p._data(e, "olddisplay") || Fe(e.nodeName) : l) &&
                        "none" === p.css(e, "float") &&
                        (d.inlineBlockNeedsLayout && "inline" !== Fe(e.nodeName) ? (h.zoom = 1) : (h.display = "inline-block"))),
                n.overflow &&
                    ((h.overflow = "hidden"),
                    d.shrinkWrapBlocks() ||
                        c.always(function () {
                ...
                if (p.isEmptyObject(f)) "inline" === ("none" === l ? Fe(e.nodeName) : l) && (h.display = l);
                    ...
                    f))
                        (a = ct(g ? m[r] : 0, r, c)), r in m || ((m[r] = a.start), g && ((a.end = a.start), (a.start = "width" === r || "height" === r ? 1 : 0)));
            },
        ],
        ...
        p.each({ slideDown: lt("show"), slideUp: lt("hide"), slideToggle: lt("toggle"), fadeIn: { opacity: "show" }, fadeOut: { opacity: "hide" }, fadeToggle: { opacity: "toggle" } }, function (e, t) {
            ...
            attr: function (e, t, n) {
                ...
                if (3 !== o && 8 !== o && 2 !== o)
                    return void 0 === e.getAttribute
                        ? p.prop(e, t, n)
                        : ((1 === o && p.isXMLDoc(e)) || ((t = t.toLowerCase()), (i = p.attrHooks[t] || (p.expr.match.bool.test(t) ? gt : ht))),
                          void 0 !== n
                              ? null === n
    ...
    p.fn.extend({
        ...
        toggleClass: function (e, t) {
            ...
            return "boolean" == typeof t && "string" === n
                ...
                : this.each(function () {
                      var t, r, i, o;
                      if ("string" === n) for (r = 0, i = p(this), o = e.match(q) || []; (t = o[r++]); ) i.hasClass(t) ? i.removeClass(t) : i.addClass(t);
        ...
        hasClass: function (e) {
            var t,
                n,
                r = 0;
            for (t = " " + e + " "; (n = this[r++]); ) if (1 === n.nodeType && (" " + Ct(n) + " ").replace(Tt, " ").indexOf(t) > -1) return !0;
            return !1;
        },
    }),
    ...
    function Pt(e) {
        return function (t, n) {
            ...
            if (p.isFunction(n)) for (; (r = o[i++]); ) "+" === r.charAt(0) ? ((r = r.slice(1) || "*"), (e[r] = e[r] || []).unshift(n)) : (e[r] = e[r] || []).push(n);
        };
    }
    function Bt(e, t, n, r) {
        var i = {},
    ...
    p.extend({
        ...
        ajax: function (t, n) {
            ...
            if (
                ...
                (T.success = T.done),
                (T.error = T.fail),
                (d.url = ((t || d.url || Ot) + "").replace(At, "").replace(Ht, Rt[1] + "//")),
                (d.type = n.method || n.type || d.method || d.type),
                (d.dataTypes = p
                    .trim(d.dataType || "*")
                    .toLowerCase()
                    .match(q) || [""]),
                null == d.crossDomain && ((r = qt.exec(d.url.toLowerCase())), (d.crossDomain = !(!r || (r[1] === Rt[1] && r[2] === Rt[2] && (r[3] || ("http:" === r[1] ? "80" : "443")) === (Rt[3] || ("http:" === Rt[1] ? "80" : "443")))))),
                d.data && d.processData && "string" != typeof d.data && (d.data = p.param(d.data, d.traditional)),
                Bt(_t, d, n, T),
                2 === b)
            )
                return T;
            for (i in ((u = p.event && d.global) && 0 == p.active++ && p.event.trigger("ajaxStart"),
            (d.type = d.type.toUpperCase()),
            (d.hasContent = !Lt.test(d.type)),
            (o = d.url),
            d.hasContent || (d.data && ((o = d.url += (kt.test(o) ? "&" : "?") + d.data), delete d.data), !1 === d.cache && (d.url = Dt.test(o) ? o.replace(Dt, "$1_=" + Nt++) : o + (kt.test(o) ? "&" : "?") + "_=" + Nt++)),
            d.ifModified && (p.lastModified[o] && T.setRequestHeader("If-Modified-Since", p.lastModified[o]), p.etag[o] && T.setRequestHeader("If-None-Match", p.etag[o])),
            ...
            for (i in ((w = "abort"), { success: 1, error: 1, complete: 1 })) T[i](d[i]);
            if ((l = Bt(Ft, d, n, T))) {
            ...
            function C(t, n, r, i) {
                ...
                2 !== b &&
                    ...
                    c
                        ? (d.ifModified && ((C = T.getResponseHeader("Last-Modified")) && (p.lastModified[o] = C), (C = T.getResponseHeader("etag")) && (p.etag[o] = C)),
                          204 === t || "HEAD" === d.type ? (E = "nocontent") : 304 === t ? (E = "notmodified") : ((E = w.state), (y = w.data), (c = !(x = w.error))))
                    ...
                    m.fireWith(f, [T, E]),
                    u && (h.trigger("ajaxComplete", [T, d]), --p.active || p.event.trigger("ajaxStop")));
            }
            return T;
        },
        ...
        p.each(["get", "post"], function (e, t) {
            p[t] = function (e, n, r, i) {
                return p.isFunction(n) && ((i = i || r), (r = n), (n = void 0)), p.ajax(p.extend({ url: e, type: t, dataType: i, data: n, success: r }, p.isPlainObject(e) && e));
            };
        }),
        ...
        p.ajaxPrefilter("json jsonp", function (t, n, r) {
            ...
            return s || "jsonp" === t.dataTypes[0]
                ? ((i = t.jsonpCallback = p.isFunction(t.jsonpCallback) ? t.jsonpCallback() : t.jsonpCallback),
                  s ? (t[s] = t[s].replace(tn, "$1" + i)) : !1 !== t.jsonp && (t.url += (kt.test(t.url) ? "&" : "?") + t.jsonp + "=" + i),
        ...
        (p.offset = {
            setOffset: function (e, t, n) {
                ...
                "static" === l && (e.style.position = "relative"),
                    ...
                    (o = p.css(e, "top")),
                    (u = p.css(e, "left")),
                    ("absolute" === l || "fixed" === l) && p.inArray("auto", [o, u]) > -1 ? ((a = (r = c.position()).top), (i = r.left)) : ((a = parseFloat(o) || 0), (i = parseFloat(u) || 0)),
